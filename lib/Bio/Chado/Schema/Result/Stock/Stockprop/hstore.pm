package Bio::Chado::Schema::Result::Stock::Stockprop::hstore;

BEGIN {
    $Bio::Chado::Schema::Result::Stock::Stockprop::hstore::AUTHORITY
        = 'cpan:YPANDIT';
}
{
    $Bio::Chado::Schema::Result::Stock::Stockprop::hstore::VERSION = '0.0.1';
}
...
__PACKAGE__->table("stockprop_hstore");
